...
<html>
	<head>
		...
		<link href="achievement_site/achievement.css?ver=1.3" rel="stylesheet" type="text/css" /> 
		...
		<h1>Steam Achievement Formatter</h1>
			...
			<div id='left'>
				<dl>
					...
					Using Steam id:<div id="entered">None Yet</div>
				...
				<div id="options">
					...
					<ul id="optionsul">
                        ...
                        <button id="updater" onclick=achievement.php >Update Text</button>
